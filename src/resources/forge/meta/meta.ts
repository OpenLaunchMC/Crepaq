...
<<<<<<< HEAD:src/download/forge/meta/meta.ts
...
export function getForgeInstallerMetadata() {
  return axios
    .get("https://files.minecraftforge.net/net/minecraftforge/forge/")
    .then((res) => {
...
export function getForgeInstallerMetadata() {
  axios.get();
>>>>>>> d40b8b6b86c86ad889786dad75ddc8c58a2d8f7d:src/resources/forge/meta/meta.ts
}
